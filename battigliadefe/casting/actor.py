...
class Actor:
    ...
    def get_sermon_attack(self):
        """
        sets up the sermon attack method for later morphing
        """
        return self._sermon_attack
    
    def get_character_class(self):
        """
        sets up the character class method for later morphing
        """
